...
import com.github.paohaijiao.server.impl.JQuickNonBlockingServer;
import com.github.paohaijiao.transport.JQuickTransportFactory;

/**
 * 非阻塞服务器工厂
 */
public class JQuickNonBlockingServerFactory implements JQuickServerFactory {
    ...
    public JQuickThriftServer create(JQuickServerConfig config, JQuickProtocolFactory protocolFactory, JQuickTransportFactory transportFactory) {
        return new JQuickNonBlockingServer(config, protocolFactory, transportFactory);
    }
